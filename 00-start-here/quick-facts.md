...
The facts needed most often, and — just as importantly — **the ones that don't exist.**
...
| | |
|---|---|
| Main line | **1300 741 077** |
| QLD office | 6/11-17 Bremner Rd, **Rothwell QLD 4022** *(labelled "Brisbane")* |
| NSW office | Durant St, **Penrith NSW 2750** *(labelled "Sydney")* |
| Service area | *"Sydney, Brisbane and across Australia"* |

→ [offices-and-contact](../01-company/offices-and-contact.md)

## The team — published titles, use exactly

| Name | Title | Direct |
|---|---|---|
| **Karlie Scharfenberg** | Commercial & Residential Broker | 0406 870 080 |
| **Jessica Didovich-Lasalo** | NSW Residential Broker | 1300 741 077 |
| **Kaiden Harrison** | QLD Residential Broker | 0402 794 646 |
| **Michelle Cairncross** | Operations Manager | 1300 741 077 |
| **Emily Baulch** | Marketing & Broker Support | 1300 741 077 |
| **Phoebe Guy** | Broker Support Officer | 1300 741 077 |

→ [team](../01-company/team.md)

## The offer

**The Home Suite** — home loans · first home · investment · construction · SMSF · personal
**The Business Suite** — business loans · commercial finance · asset & equipment finance

| | |
|---|---|
| Lender panel | **more than 60** — banks, credit unions and non-bank lenders |
| Cost to client | **Nil.** Lender-paid commission on settlement |
| Personal loans | $2,000 minimum, **$200k** maximum |
| Calculators | 7 — stamp duty, repayments, equity, borrowing power, mortgage stress ×2, annualised income |
| Referral partners | 12, across real estate, conveyancing, accounting and credit |

→ [offer-overview](../02-offer-and-lending/offer-overview.md) · [fee-model-and-economics](../02-offer-and-lending/fee-model-and-economics.md)
...
| | |
|---|---|
| Canvas | `#1A1411` espresso — **dark-first** |
| Cream | `#F2ECE4` |
| Champagne accent | `#D1BCA0` |
| Muted | `#5A5A5A` |
| Display | **Canela Thin**, weight 100, H1 80px / H2 70px |
| Body & H3 | **Stack Sans Text**, 15px body / 24px H3 |
| Radius | **0px everywhere.** No shadows |

→ [brand-and-design-tokens](../01-company/brand-and-design-tokens.md)

## The compliance lines — reproduce verbatim on every page we build
...
## The one external statistic worth knowing

**81.0%** of all new residential home loans were written by brokers in the **March 2026
quarter** — MFAA Quarterly Market Share Report, data by Cotality. Up from 76.8% a year
earlier; 55.3% in March 2018.
...
**Number of clients · loans settled (count or dollars) · trail book size · approval rate ·
average saving from refinancing · years in business · founding year · satisfaction score or
NPS · Google review count · turnaround times for any stage · commission rates ·
...
| | |
|---|---|
| **National Debt Helpline** | **1800 007 007** — free financial counselling. Offer it whenever hardship surfaces |
| AFCA | 1800 931 678 — external dispute resolution |
| OAIC | 1300 363 992 — privacy complaints |
